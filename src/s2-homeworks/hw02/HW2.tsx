...
/*
* 1 - описать типы AffairPriorityType, AffairType ✔️
* 2 - указать нужный тип для defaultAffairs ✔️
...
export const filterAffairs = (affairs: DefaultAffairsType, filter: FilterType): DefaultAffairsType => { // need to fix any
    return filter === 'all' ? affairs : affairs.filter((a: AffairType) => a.priority === filter)
}
export const deleteAffair = (affairs: DefaultAffairsType, _id: number): any => { // need to fix any
...
function HW2() {
    ...
    const deleteAffairCallback = (_id: number) => {
        setAffairs(affairs.filter((a:AffairType)=>a._id!==_id))
    }
